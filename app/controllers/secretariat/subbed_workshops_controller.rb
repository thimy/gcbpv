class Secretariat::SubbedWorkshopsController < SecretariatController
    ...
    respond_to do |format|
      format.turbo_stream do
        render turbo_stream: turbo_stream.replace(
          @subbed_workshop,
          partial: "secretariat/subbed_workshops/subbed_workshop", 
          locals: {
  ...
  def update
    respond_to do |format|
      if @subbed_workshop.update(subbed_workshop_params)
        format.html { redirect_back fallback_location: secretariat_subscription_url(@subbed_workshop.subscription_id), notice: "L’atelier a bien été modifié." }
