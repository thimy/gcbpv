class Secretariat::PostsController < SecretariatController
  ...
  def create
    ...
    respond_to do |format|
      if @post.save
        ...
        format.html { redirect_to secretariat_post_url(@post), notice: "L’article a bien été enregistré." }
  ...
  def update
    respond_to do |format|
      if @post.update(post_params)
        @post.save_attachments
        format.html { redirect_to secretariat_post_url(@post), notice: "L’article a bien été modifié." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to secretariat_posts_url, notice: "L’article a bien été supprimé." }
  ...
  def send_post
    ...
    respond_to do |format|
      format.html { redirect_to secretariat_post_url(@post) }
    end
  end
