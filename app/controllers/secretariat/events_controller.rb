class Secretariat::EventsController < SecretariatController
  ...
  def create
    ...
    respond_to do |format|
      if @event.save
        ...
        format.html { redirect_to secretariat_event_url(@event), notice: "L’événement a bien été enregistré." }
  ...
  def update
    respond_to do |format|
      if @event.update(event_params)
        @event.save_attachments
        format.html { redirect_to secretariat_event_url(@event), notice: "L’événement a bien été modifié." }
