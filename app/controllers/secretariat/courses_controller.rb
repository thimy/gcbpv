class Secretariat::CoursesController < SecretariatController
    ...
    respond_to do |format|
      format.turbo_stream do
        render turbo_stream: turbo_stream.replace(
          @course,
          partial: "secretariat/courses/course", 
          locals: {
            course: @course,
            is_form: false
          }
  ...
  def create
    ...
    respond_to do |format|
      if @course.save
        format.html { redirect_to secretariat_course_url(@course), notice: "Le cours a bien été enregistré." }
  ...
  def update
    respond_to do |format|
      if @course.update(course_params)
        format.html { redirect_back fallback_location: secretariat_course_url(@course), notice: "Le cours a bien été modifié." }
