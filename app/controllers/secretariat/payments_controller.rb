class Secretariat::PaymentsController < SecretariatController
    ...
    respond_to do |format|
      format.turbo_stream do
        render turbo_stream: turbo_stream.replace(
          @payment,
          partial: "secretariat/payments/payment", 
          locals: {
            payment: @payment,
            is_form: false
          }
  ...
  def update
    respond_to do |format|
      if @payment.update(payment_params)
        format.html { redirect_back fallback_location: secretariat_payor_url(@payment.subscription_group.payor), notice: "Le paiement a bien été modifié." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to secretariat_payor_url(@payor_id), notice: "Le paiement a bien été supprimé." }
