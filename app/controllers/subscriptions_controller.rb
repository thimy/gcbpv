class SubscriptionsController < SecretariatController
  ...
  def subscription_params
    ...
    params.require(:subscription).permit(:student_id, :subscription_group_id, :ars, :disability, :image_consent, :status, :comment, courses_attributes: [:instrument_id, :slot_id, :option, :comment], subbed_workshops_attributes: [:workshop_slot_id, :option, :comment], loan_attributes: [:id, :instrument, :cost, :comment, :subscription_id], student_attributes: [:id, :first_name, :last_name, :phone, :email, :gender, :address, :postcode, :city, :birth_year, :comment])
  end
