...
class HouseholdsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create household" do
    assert_difference("Household.count") do
      post households_url, params: { household: { email: @household.email, first_name: @household.first_name, last_name: @household.last_name, phone: @household.phone } }
    end
  ...
  test "should update household" do
    patch household_url(@household), params: { household: { email: @household.email, first_name: @household.first_name, last_name: @household.last_name, phone: @household.phone } }
