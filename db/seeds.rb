...
workshops = [{
  ...
  name: "Atelier autonome harmonica",
  teacher_ids: [19],
  day_of_week: 5,
  frequency: 2,
  city_id: 1,
  start_time: "19h30",
  description: "Cet atelier fonctionne de façon autonome depuis 15 ans et se réunit tous les 15 jours pour travailler quelques morceaux dans une ambiance conviviale. Si vous aussi, entendez l’appel du petit instrument, n’hésitez plus... Aucun besoin de solfège, ni de partition, c’est l’apprentissage oral (à l’oreille, comme on dit) qui est privilégié.
  Retrouvez les sur : www.harmoredon.eu"
}]
